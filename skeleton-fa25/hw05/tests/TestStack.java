...
public class TestStack {
     ...
     @Test
     @Order(8)
     public void testPushPopSumTime() {
         Stack s = new Stack();
         int N = 10000000;
         ...
         System.out.println("Push Took " + (endMs - startMs) + " millliseconds.");

         startMs = System.currentTimeMillis();
         s.sum();
         endMs = System.currentTimeMillis();
         System.out.println("Sum Took " + (endMs - startMs) + " millliseconds.");

         startMs = System.currentTimeMillis();
         s.pop();
         endMs = System.currentTimeMillis();
         System.out.println("Pop Took " + (endMs - startMs) + " millliseconds.");
     }
}
